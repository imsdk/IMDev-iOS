...
- (NSString *)recentContactsView:(IMRecentContactsView *)recentContactsView contentForIndex:(NSInteger)index;

- (UIImage *)recentContactsView:(IMRecentContactsView *)recentContactsView imageForIndex:(NSInteger)index;

- (UIColor *)recentContactsView:(IMRecentContactsView *)recentContactsView textColorForIndex:(NSInteger)index;

- (UIFont *)recentContactsView:(IMRecentContactsView *)recentContactsView textFontForIndex:(NSInteger)index;
