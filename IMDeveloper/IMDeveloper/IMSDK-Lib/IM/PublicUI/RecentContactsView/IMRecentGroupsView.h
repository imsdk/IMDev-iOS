...
- (NSString *)recentGroupsView:(IMRecentGroupsView *)recentGroupsView titleForIndex:(NSInteger)index;

- (UIImage *)recentGroupsView:(IMRecentGroupsView *)recentGroupsView imageForIndex:(NSInteger)index;
@end
